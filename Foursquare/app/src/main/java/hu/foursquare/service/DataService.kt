package hu.foursquare.service

import android.graphics.Bitmap
import android.graphics.BitmapFactory
import android.util.Log
import hu.foursquare.model.details.DetailsResponse
import hu.foursquare.model.details.Photos
import hu.foursquare.model.search.SearchResponse
import hu.foursquare.model.search.Venue
import hu.foursquare.retrofit.RetrofitClient
...
class DataService {
    ...
    interface VenueDetailsCallback{
        fun getDetailsResult(result : hu.foursquare.model.details.Venue)
